...
class RegisterBloc with Validators {
  ...
  Stream<String> get confirmPassword =>
      _confirmPassword.transform(confPassValidator);
  ...
  Stream<bool> get isValid => Rx.combineLatest5(
      ...
      password,
      confirmPassword,
      (name, email, phone, password, confPass) => true);

  // To match pass with conf password..
  ...
  Function(String) get changeEmail => _emailId.sink.add;
